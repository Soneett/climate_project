...
def parse_healthcare_xlsx(
    ...
    for r in range(year_row_idx + 1, len(df0)):
        ...
        if is_subrow:
            indicator_name = f"{current_group} — {name_clean}"
...
if __name__ == "__main__":
    # путь к файлу
    xlsx_path = "/home/daria/altay-db/Основные показатели здравоохранения в Республике Алтай(3).xlsx"
    out_path = "/home/daria/altay-db/healthcare_altai.json"
