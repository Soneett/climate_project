...
from services.parsers.registry import get_parser_config, list_parser_options
...
class DataUploadService:
    ...
    async def upload_file(self, session: Session, file: UploadFile, indicator_key: str) -> dict:
        ...
        if parser_config is None:
            raise HTTPException(
                status_code=400,
                detail=f"Unknown indicator_key '{indicator_key}'. Use /data/upload/indicators endpoint.",
            )
        ...
        try:
            ...
            return {
                ...
                "indicator": parser_config.label,
                "indicatorKey": parser_config.key,
                "uploaded": uploaded,
                "skipped": skipped,
            }
