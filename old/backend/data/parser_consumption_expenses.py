                ...
                rows.append(
                    {
                        ...
                        "year": year,
                        "indicator_name": f"{metric} — {current_group}" if current_group else metric,
                        "value": val,
                        "unit_code": "руб_мес",
                    }
                )
...
if __name__ == "__main__":
    xlsx_path = "C:/Users/kukoc/Desktop/2215/old/backend/data/consumption_expenses.xlsx"
    out_path = "C:/Users/kukoc/Desktop/2215/old/backend/data/indicator_values/consumption_expenses.json"
